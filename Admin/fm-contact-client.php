                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="Name" name="Name" value="<?php echo $FirstName." ".$LastName; ?>" placeholder="Client Name" disabled required autofocus > 
                                            </div>
                 ...
                 <?php endwhile; 
                  ...
                  if(isset($_POST['editclient']))
                  {
                    ...
                    if ($con->query($sql) === TRUE) {
                        echo '<script>window.location.href="fm-contact-client.php"</script>';
                    } else {
