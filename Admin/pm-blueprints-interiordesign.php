...
$query = "SELECT * FROM project as p, employee as e, interiordesign as i WHERE i.CliEntId = p.ClientID AND  e.EmpId = p.EmpId AND p.isdelete = 0 AND p.ServiceTypeId = 2 AND p.Progress < 100";
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <!--</td>-->
                                <td style="text-align: center;">
                                    <button type="button" id="<?php echo $ProjectId; ?>" data-toggle="modal" <?php echo $disable_validate ? "disabled" : " "; ?> class="show-blueprint-interior btn btn-warning btn-sm btn-block font-weight-bold" style="font-size: 13px;">
