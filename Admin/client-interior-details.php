...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            // $sqlDesired = "SELECT * FROM fitout JOIN project ON fitout.ProjectId = project.ProjectId WHERE project.ClientId = '$ClientID';";
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Site Location</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" autocomplete="none" value="<?php echo $rowProject['SiteLocation'] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Date Visited</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" autocomplete="none" value="<?php echo $rowProject['VisitationDate'] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Design Style</label>
                                                <input type="text" class="form-control" value="<?php echo $rowProject['DesignStyle'] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Space Type</label>
                                                <input type="text" class="form-control" value="<?php echo $rowProject['SpaceType'] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Length</label>
                                                <input type="text" class="form-control" value="<?php echo $rowProject['Length'] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Width</label>
                                                <input type="text" class="form-control" value="<?php echo $rowProject['Width'] ?>" disabled>
                                            </div>
                                        </div>
                                       <!--  <div class="col-sm-6">
                                            <div class="form-group">
 ...
 -->                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" disabled><?php echo $rowProject['OverviewDescription'] ?></textarea>
                                            </div>
                                        </div>
