...
{
$ID = $_POST['ID'];
 $query = "SELECT * FROM project as p, employee as e, fitout as f  WHERE f.ProjectId = p.ProjectId AND  e.EmpId = p.EmpId AND p.isdelete = 0 AND p.ServiceTypeId = 3 AND p.Progress < 100 AND p.ProjectId = '$ID'";
