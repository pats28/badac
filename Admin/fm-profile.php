                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center container">
                                <?php
                                if (empty($row['image'])) {
                                    echo "<img class='profile-user-img img-circle' style='object-fit: cover;height: 110px;width: 110px;' src='images/default-user-image.png'>";
                                } else {
                            ...
                            <p class="text-muted text-center">Financial Manager</p>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                if (isset($_POST['UpdateProfile'])) {
                                    ...
                                    $page = $_SERVER['REQUEST_URI'];
                                    echo '<script type="text/javascript">';
                                    echo 'window.location.href="fm-profile.php";';
                                    echo '</script>';
                                }
                                ?>
