    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Contact | Store</h3>

          <div class="col-12">
            <!-- <a href="C:/Users/Gerald/Desktop/UpdatedAdmin/AdminLTE-3.0.2/pages/examples/project_add.html">
          <input  type="submit" value="Add Store" class="btn btn-success float-right"></a> -->
                ...
                <?php endwhile; 
                  ...
                  if(isset($_POST['editstore']))
                  {
                    ...
                    if ($con->query($sql) === TRUE) {
                        echo '<script>window.location.href="ar-contact-vendor.php"</script>';
                    } else {
