                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Furniture Type</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" autocomplete="none" value="<?php echo $rowDesired['FurnitureType'] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Length</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" autocomplete="none" value="<?php echo $rowDesired['Length'] ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Width</label>
                                                <input type="text" class="form-control" value="<?php echo $rowDesired['Width'] ?>" disabled>
                                            </div>
                                        </div>
                                       <!--  <div class="col-sm-3">
                                            <div class="form-group">
