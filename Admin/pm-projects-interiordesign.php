...
<?php
   ...
   $query = "SELECT * FROM project as p, client as c, employee as e, interiordesign as id, payment as pay WHERE id.ClientId = p.ClientId AND c.ClientId = p.ClientId AND e.EmpId = p.EmpId AND p.isdelete = 0 AND p.ServiceTypeId = 2 AND p.ProjectId = pay.ProjectId";
          ...
          <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><strong><?php echo $ProjectName; ?></strong></br><?php echo $FirstName." ".$LastName;?></td>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">Interior Design Details</h4>
                              ...
                              <div class="modal-body">
                               ...
                               <!--  <h5>Fit-Out Details</h5> -->
                                <div class="col-md-12">
                                  ...
                                  <input type="text" name="SiteLocation" id="SiteLocation" value="<?php echo $SiteLocation; ?>" class="form-control"   required="" disabled > 
                                </div> 
                                <div class="col-md-6">
                                  <label>Design Style</label>
                                  <input type="text" name="DesignStyle" id="DesignStyle" value="<?php echo $DesignStyle; ?>" class="form-control" disabled > 
                                </div> 
                                <div class="col-md-6">
                                  <label>Space Type</label>
                                  <input type="text" name="SpaceType" id="SpaceType" value="<?php echo $SpaceType; ?>" class="form-control" disabled > 
                                </div> 
                                <div class="col-md-6">
                                  <label>Length</label>
              ...
              <?php endwhile; 
                 ...
                 // edit project process
                  if(isset($_POST['editproject']))
                  {
                    ...
                    if ($con->query($sql) === TRUE) {
                        echo '<script>window.location.href="pm-projects-interiordesign.php"</script>';
                    } else {
                ...
                //   $Drawing = $_POST['Drawing'];
                  ...
                  if ($con->query($sql1) === TRUE )
                  {
                      ...
                      $sqlInterior = "INSERT INTO interiordesign (VisitationDate, Length, Width, OverviewDescription, SiteLocation, SpaceType, DesignStyle, ClientId) VALUES ('$VisitationDate', '$Length', '$Width', '$OverviewDescription','$SiteLocation', '$SpaceType', '$DesignStyle', '$ClientId')";
                      
                      if ($con->query($sql2) === TRUE && $con->query($sqlInterior) === TRUE )
                      {
                         ...
                         $ProjectId = $MaxProjectId['ProjectId'];
                            ...
                            // $sql3 = "INSERT INTO interiordesign (VisitationDate, Length, Width, Description, Drawing, ProjectId) VALUES ('$FurnitureType', '$Length', '$Width', '$Description','$Drawing', '$ProjectId')";
                            ...
                            if ($con->query($sql4) === TRUE && $con->query($sql8) === TRUE && $con->query($sql9) === TRUE )
                            {
                      ...
                      {
                        echo "\nError2: " . $sql2 . "<br>" . $con->error;  
                        echo "\nError3: " . $sqlInterior . "<br>" . $con->error;   
                      }
                  }
                  else
                  {
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class = "row"> 
                ...
                <div class="col-md-6">
                    <label>Visitation Date<span class="text-danger">*</span></label>
                    <input type="date" name="VisitationDate" id="VisitationDate" class="form-control" required > 
                </div>
                <div class="col-md-6">
                    <label>Site Location<span class="text-danger">*</span></label>
                    <input type="text" name="SiteLocation" id="SiteLocation" class="form-control" placeholder="Location" required > 
                </div>
                <div class="col-md-6">
                    <label>Design Style<span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <label>Space Type<span class="text-danger">*</span></label>
                    <input type="text" name="SpaceType" id="SpaceType" class="form-control" placeholder="e.g. Living Area, Bedroom, etc" required > 
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <label>Description</label>
                    <textarea name="OverviewDescription" id="OverviewDescription" class="form-control" rows = "4" placeholder="Description"></textarea> 
                </div>
