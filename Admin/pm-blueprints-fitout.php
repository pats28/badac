...
$query = "SELECT * FROM project as p, employee as e, fitout as f WHERE e.EmpId = p.EmpId AND p.isdelete = 0 AND f.ProjectId = p.ProjectId AND p.ServiceTypeId = 3 AND p.Progress < 100";
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Fitout</li>
                    </ol>
                </div>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header" style="background-color: #708090">
                <h3 class="card-title" style="color: white">Fitout</h3>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <!--</td>-->
                                <td style="text-align: center;">
                                    <button type="button" id="<?php echo $ProjectId; ?>" data-toggle="modal" <?php echo $disable_validate ? "disabled" : " "; ?> class="show-blueprint-fitout btn btn-warning btn-sm btn-block font-weight-bold" style="font-size: 13px;">
