          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="EmpName" name="EmpName" value="<?php echo $EmpFirstName." ".$EmpLastName; ?>" placeholder="Employee Name" disabled required autofocus > 
                                            </div>
                                            ...
                                            <label>Department</label>
                                                <!-- <input type="text" name="DeptName" id="DeptName" class="form-control" required=""> -->
                                                <select name="DeptName" id="DeptName" class="form-control" required="" disabled>
                                                  <option value="Architect">Architect
                                                  <option value="Finance">Finance
                                                  <option value="Construction">Construction
                                                </select>        
                 ...
                 // edit employee process
                  if(isset($_POST['editemployee']))
                  {
                    ...
                    if ($con->query($sql) === TRUE) {
                        echo '<script>window.location.href="fm-contact-employee.php"</script>';
                    } else {
                ...
                if(isset($_POST['addemployee']))
                {
                  ...
                  $sql = "INSERT INTO employee (EmpName,Address,Email,ContactNum, DeptId)VALUES ('$EmpFirstName', '$EmpLastName','$Address','$Email','$ContactNum', '$DeptId')";
                  if ($con->query($sql) === TRUE) 
                      {                  
                          echo '<script>window.location.href="fm-contact-employee.php"</script>';
                      } 
